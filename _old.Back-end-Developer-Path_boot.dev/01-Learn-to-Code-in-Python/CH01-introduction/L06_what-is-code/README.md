...
We can also use it to print *numbers*. Numbers, unlike plain [text strings](<https://en.wikipedia.org/wiki/String_(computer_science)>), *are not* surrounded in quotes. This prints the number `42`:

`print(42)`

- **Adding Numbers**
  [Addition](https://en.wikipedia.org/wiki/Addition) is one of the most common instructions in programming. This *also* prints the number `42`:
  `print(40 + 2)`
